...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (counter) {
    ...
    var box = currentBox;
    do {
      var css = box.node.style.cssText.toString();
...
var ConfirmBox = function (_Box2) {
  ...
  function ConfirmBox(text, events) {
    ...
    var _this2 = _possibleConstructorReturn(this, (ConfirmBox.__proto__ || Object.getPrototypeOf(ConfirmBox)).call(this, option, events));
