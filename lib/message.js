...
exports.setDefault = exports.config = exports.root = exports.current = exports.pop = exports.toast = exports.confirm = exports.alert = undefined;
...
var setDefault = exports.setDefault = function setDefault(option) {
  if (option && (typeof option === 'undefined' ? 'undefined' : _typeof(option)) === 'object') Object.assign(defaultOption, option);
