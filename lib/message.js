...
export var alert = function alert(text, events) {
  return new AlertBox(text, events);
};
export var confirm = function confirm(text, events) {
  return new ConfirmBox(text, events);
};
export var toast = function toast(text, timeout) {
  return new ToastBox(text, timeout);
};
export var pop = function pop(option) {
  return new PopBox(option);
};
export var current = function current() {
  return currentBox;
};
...
export var config = function config(option) {
