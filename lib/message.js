...
function append(self) {
  ...
  //绑定关闭事件
  var cssText = 'position:fixed;z-index:' + ((message.option.zIndex > 0 ? message.option.zIndex : 10000) + counter) + ';',
      i = 0,
...
var PopBox = function (_Box4) {
  ...
  function PopBox(option, events) {
    _classCallCheck(this, PopBox);

    var _this4 = _possibleConstructorReturn(this, (PopBox.__proto__ || Object.getPrototypeOf(PopBox)).call(this, option, events));
